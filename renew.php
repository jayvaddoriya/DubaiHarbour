            ...
            <div class="container py-md-3">
                ...
                <div class="row g-4">
                    <div class="col-xl-7">
                            ...
                            <div class="auth__form__box box__shadow bg-white py-4 px-3 px-md-0 rounded-4 mt--1 mt-md-2">
                                <p class="text-dark lead-sm fw-semibold m-0 px-4 pb-3">Documents</p> 
