            ...
            <div class="container py-md-3">
                ...
                <div class="row g-4">
                    <div class="col-xl-7">
                        ...
                        <div class="box__shadow bg-white pt-4 pb-3 px-3 px-md-0 rounded-top-4 mt--1 mt-md-2">
                            <p class="text-dark lead-lg fw-semibold m-0 px-md-4 pb-md-3">Permit to Work - <span class="lead-sm text-gray">Renew</span></p> 
                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="permit__col border-start">
                                        <div class="d-flex justify-content-center align-items-center gap-3 "> 
                                            <span class="fs-6 fw-semibold text-2b text-uppercase">Renew permit</span>
                                        </div>
                                    </div>
                                </div>
                            </div> 
                        ...
                        <div class="auth__form__box box__shadow bg-white pb-4 px-3 px-md-0 rounded-bottom-4 mt--1">
                            <ul class="document__list renew__permit__list list-unstyled ps-0 mb-0">
                                <?php include('includes/components/permit-list-item-card.inc.php'); ?>
                                <?php include('includes/components/permit-list-item-card.inc.php'); ?>
                                <?php include('includes/components/permit-list-item-card.inc.php'); ?>
                                <?php include('includes/components/permit-list-item-card.inc.php'); ?>
                                <?php include('includes/components/permit-list-item-card.inc.php'); ?>
                    ...
                    <div class="col-lg-5">
                        ...
                        <div class="auth__form__box box__shadow bg-white rounded-bottom-4 mt-md-2 mt--1">
